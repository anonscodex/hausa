...
const Expressoion = ({setProgress, progress}) => {
    ...
    return ( 
        <div className="p-8">
        <h1 className="text-2xl font-semibold mt-4 px-3">Expression</h1>
        <div className=" ml-1 w-full flex flex-wrap justify-center">
            {expression.map((expressions, index) => (
                <div key={index} className=" sm:flex lg:w-1/8 ">
                    ...
                    <div className="text-lg text-black hover:bg-green-500 hover:text-white bg-white m-3 p-3  border border-b mt-2 rounded-lg ">
                            <div className=" mx-5">{expressions.english}</div>
                            <hr/>
                            <div className="text-1xl ">{expressions.hausa}</div>
                    </div>
                    </div>
                </div>
            ))}
